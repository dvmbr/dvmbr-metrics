...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-48 rounded-md border border-border bg-elevated p-1 text-foreground shadow-lg",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-(--overlay-hover) data-disabled:pointer-events-none data-disabled:opacity-40",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-xs font-medium text-foreground-secondary",
      className,
    )}
    {...props}
  />
